...
ST <- read_excel("620GroupData.xlsx", sheet = "01_ScreenActivity")
...
write.csv(SSX, '01_SSX.csv', row.names = FALSE)
write.csv(SSY, '01_SSY.csv', row.names = FALSE)
write.csv(SSXY, '01_SSXY.csv', row.names = FALSE)
write.csv(cbind(SST,mean(dfY)), '01_SST.csv', row.names = FALSE)
write.csv(n, '01_n.csv', row.names = FALSE)
